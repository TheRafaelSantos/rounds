    ...
    *,
    ...
    for _, row in final_games.iterrows():
        parts = [
            ...
            f"score_temporal_profundo={_safe_float(row, 'score_temporal_profundo', 50.0):.6f}",
    ...
    lines.extend(
        [
            ...
            "7. score temporal profundo: dia da semana, ultimos 15/30 dias, bimestre, trimestre e semestre;",
            "8. score de cenarios: soma baixa/media/alta, sequencias, faixas historicas e visual forte permitido;",
            "9. score contrarian: protege dezenas que o score tradicional poderia excluir, como canto, centro e faixa alta;",
            "10. score de transicao: compara cada concurso N com N+1 no historico e pontua repeticoes, entradas, saidas e estrutura de mudanca;",
            "11. varredura exaustiva das combinacoes possiveis;",
            "12. contexto protegido: lua, numerologia, dia da semana e localidade continuam como bonus, mas nao podem derrubar sozinhos um candidato com consenso, transicao e risco de falso negativo relevantes;",
            "13. anti-falso-negativo: identifica dezenas menos consensuais, mas presentes em candidatos fortes, para evitar exclusao total do jogo final;",
            "14. seletor inteligente do Jogo 2: entre os candidatos que respeitam a diversidade minima, escolhe o melhor score de portfolio combinando decisao protegida, score final, transicao, contexto protegido, forca dos componentes, risco de falso negativo e dezenas diferentes do Jogo 1;",
            "15. diversidade minima entre os dois jogos.",
            "",
